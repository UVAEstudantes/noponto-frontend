...
export default function LocalButton({ location, mapRef }: { location: any; mapRef: React.RefObject<any> }) {
  ...
  return <Pressable onPress={locationUser} accessibilityRole="button" accessibilityLabel="Centralizar mapa na sua localização" hitSlop={8} style={{ borderRadius: 999, width: 48, height: 48, backgroundColor: cores.fundoPainel, borderWidth: 1, borderColor: cores.borda, alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOpacity: 0.15, shadowRadius: 6, elevation: 4 }}><LocateFixed color={cores.iconePrimario} size={24} /></Pressable>;
}
